...
export class Message {
  ...
  constructor(
    ...
    if (this.proto.pb_package === 'google.protobuf' || (!!Services.Config.customWellKnownTypes && !!Services.Config.customWellKnownTypes[this.proto.pb_package])) {
      this.isWkt = true;
  ...
  print(printer: Printer) {
    ...
    const constructorComment = this.isWkt ? `Well known type, more at ${wktUrl}` : `Message implementation for ${messageId}`;
